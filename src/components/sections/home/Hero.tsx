...
const DEFAULT_HERO = {
  badge: 'Nouveau : Devis en ligne gratuit',
  title: 'Installation de cloisons professionnelle avec',
  titleHighlight: 'A Cloison Installer',
  description:
    "Spécialistes de l'installation de cloisons sèches, verrières et séparations sur mesure. Solutions rapides et durables pour particuliers et professionnels en France.",
  features: [
  ...
  imageAlt: 'Installation de cloison moderne',
  statsLabel1: 'Projets réalisés',
  statsValue1: '500+ chantiers',
  statsLabel2: 'Satisfaction client',
  statsValue2: '98% satisfaits',
} as const;
